...
Write-Host ""
Write-Warning "O worker NAO sobe ainda: as assinaturas P/Invoke da EasyInner.dll nao foram"
Write-Warning "obtidas, entao ele sai com codigo 2. O supervisor vai tentar, falhar e por o"
Write-Warning "grupo em quarentena - que e o comportamento correto, e nao um sistema operando."
Write-Warning "Ver installer/README.md e docs/11, secao 5."
